...
datapath=/ds-av/public_datasets/kitti2015/raw/training #/ds-av/public_datasets/freiburg_sceneflow_subset/raw
datatype=2015
load_numpy=0
flip_vertical=0
epochs=3500
...
train_bsize=8 #10
test_bsize=1 #4
save_path=finetune_results/tr55-smooth
print_freq=1
...
quantFL=8 #8
####for testing
testFile=/kitti_2015_model_cf_fact3d_3stages/checkpoints/best_checkpoints/best-tr55_smooth-kitti2015-epoch_3419.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
