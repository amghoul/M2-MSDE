...
quantFL=8 #8
####for testing
testFile=/kitti_2012_model_cf_fact3d_3stages/checkpoints/best_checkpoints/best-tr55-smooth-kitti2012-epoch_3491.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
