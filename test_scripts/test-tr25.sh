...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_4stages/checkpoints/best_checkpoints/best-tr25-ab13-epoch_476.pth
### for resuming
...
python  args_file.py --stages $stages --dataset $dataset --model $model --mode $mode --datapath $datapath \
