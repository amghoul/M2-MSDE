...
epochs=600
lr=0.001
ch_lr_after=10 # FT3d = 20, kitti=200
stepsize=10 # FT3d=10, kitti=50
train_bsize=8 #10
test_bsize=1 #4
save_path=results/tr60-chout-08-sf4-subpixel1-skip-gerf
print_freq=50
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_3stages/checkpoints/best_checkpoints/best-tr60--epoch_215.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
...
patch_index=2
is_costvolume_4D=1
chout_costfiltring=8 #0: determinc ch_out in costfiltrting layer accordding to the value of initial_scale_factor
BN_2D_last=0
