...
train_bsize=8 #10
test_bsize=1 #4
save_path=results/tr58-chout-32-sf4-subpixel1-noskip
print_freq=50
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_3stages/checkpoints/best_checkpoints/best-tr58-epoch_266.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
resume=0 # resume path
resumeFile=None #/sceneflow_model_cf_fact3d_3stages/checkpoints/best_checkpoints/checkpoint-epoch_20-sumlosses_6.35174.pth
####for model=cf_fact3d
model_bn=1
BN_1D_last=1
BN_1D=1
