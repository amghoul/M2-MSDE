...
train_bsize=4 #10
test_bsize=4 #4
save_path=results/chin-1-chout-1-pixelacc-05-sf4-lr
print_freq=50
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_3stages/checkpoints/best_checkpoints/checkpoint-epoch_43-sumlosses_22.14065.pth
### for resuming
...
patch_index=2
is_costvolume_4D=1
chout_costfiltring=1 #0: determinc ch_out in costfiltrting layer accordding to the value of initial_scale_factor
BN_2D_last=0
