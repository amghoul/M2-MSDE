...
train_bsize=4 #10
test_bsize=4 #4
save_path=results/chin-1-chout-32-pixelacc-1-sf2-lr
print_freq=50
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_3stages/checkpoints/best_checkpoints/checkpoint-epoch_21-sumlosses_11.90229.pth
### for resuming
