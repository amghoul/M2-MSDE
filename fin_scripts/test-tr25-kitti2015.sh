...
datapath=/ds-av/public_datasets/kitti2015/raw/training # /netscratch/alkoutayni/StereoMatching/Datasets/FlyingThings3D    /netscratch/alkoutayni/StereoMatching/Datasets/kitti2015/training  /netscratch/alkoutayni/StereoMatching/Datasets/kitti2012/training
datatype=2015
flip_vertical=0
epochs=3500
lr=0.001
...
quantFL=8 #8
####for testing
testFile=/kitti_2015_model_cf_fact3d_4stages/checkpoints/best_checkpoints/best-tr25-ab13-noflip-k2015-epoch_3968.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
