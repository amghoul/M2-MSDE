...
quantFL=8 #8
####for testing
testFile=/kitti_2015_model_cf_fact3d_3stages/checkpoints/best_checkpoints/best-tr55-gerf-epoch_3374-sumlosses_1.74847.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
