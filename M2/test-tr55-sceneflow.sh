...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_3stages/checkpoints/best-tr55-epoch_282.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
