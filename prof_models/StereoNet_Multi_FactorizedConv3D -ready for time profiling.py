    ...
    for initial_scale_factor in initial_scale_factor_list:
        for chout_costfiltring in chout_costfiltring_list:
            for sub_pixel_acc in sub_pixel_acc_list:
                ...
                model = StereoNet(r=stages, initial_ch=8, num_convs_in_layers=[2,2,2], initial_scale_factor=initial_scale_factor, disp_offset=2,sub_pixel_acc=sub_pixel_acc,patch_index=2,
                ...
                model_time = StereoNetTime(r=stages, initial_ch=8, num_convs_in_layers=[2,2,2], initial_scale_factor=initial_scale_factor, disp_offset=2,sub_pixel_acc=sub_pixel_acc,patch_index=2,
                    is_costvolume_4D=1,BN_2D_last=0, chout_costfiltring=chout_costfiltring, is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels, fact_kernels=fact_kernels,
                    BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).to(device)
                model_memlab = StereoNetProf(r=stages, initial_ch=8, num_convs_in_layers=[2,2,2], initial_scale_factor=initial_scale_factor, disp_offset=2,sub_pixel_acc=sub_pixel_acc,patch_index=2,
                    is_costvolume_4D=1,BN_2D_last=0, chout_costfiltring=chout_costfiltring, is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels, fact_kernels=fact_kernels,
                    BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).to(device)
